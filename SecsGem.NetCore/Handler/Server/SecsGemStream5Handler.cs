...
{
    public class SecsGemStream5Handler : ISecsGemServerStreamHandler
    {
        public async Task S5F3(SecsGemServerRequestContext req)
        {
        ...
        public async Task S5F5(SecsGemServerRequestContext req)
        {
        ...
        public async Task S5F7(SecsGemServerRequestContext req)
        {
